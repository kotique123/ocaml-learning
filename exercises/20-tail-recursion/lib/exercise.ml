...
let sum_naive (_lst : int list) : int = failwith "not implemented"

(** [sum_tr lst] sums a list using tail recursion with an accumulator. *)
let sum_tr (_lst : int list) : int = failwith "not implemented"

(** [reverse_tr lst] reverses a list using tail recursion. *)
let reverse_tr (_lst : 'a list) : 'a list = failwith "not implemented"

(** [flatten_tr lst] flattens a list of lists using tail recursion. *)
let flatten_tr (_lst : 'a list list) : 'a list = failwith "not implemented"

(** [map_tr f lst] maps [f] over [lst] in a tail-recursive way. *)
let map_tr (_f : 'a -> 'b) (_lst : 'a list) : 'b list = failwith "not implemented"

(** [fibonacci_tr n] computes the nth Fibonacci number using a tail-recursive helper. *)
let fibonacci_tr (_n : int) : int = failwith "not implemented"

(** [range lo hi] returns [[lo; lo+1; ...; hi-1]] using tail recursion. *)
let range (_lo : int) (_hi : int) : int list = failwith "not implemented"
