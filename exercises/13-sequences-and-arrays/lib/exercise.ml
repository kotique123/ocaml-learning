...
let seq_take (n : int) (seq : 'a Seq.t) : 'a list = failwith "not implemented"

(** [seq_squares n] returns the first [n] perfect squares as a list: [1;4;9;16;...] *)
let seq_squares (n : int) : int list = failwith "not implemented"
